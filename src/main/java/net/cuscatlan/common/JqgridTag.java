    ...
    private String createField(Field field, Integer separator) {
        ...
        if (type.equals("java.lang.Integer") || type.equals("java.lang.Float") || type.equals("java.lang.Long") || type.equals("java.lang.String") || type.equals("java.math.BigDecimal")) {
            ...
            try {
                ...
                fieldBuilder.append("                                               dataUrl: '/centroginecologico/cbofilter").append(cls.getName().replaceAll(pkg, "").replaceAll("\\.", "")).append("',\n");
    ...
    public void doTag() throws JspException, IOException {
        ...
        try {
            ...
            if (urlexport != null) {
                ...
                scriptBuilder.append("                  <input type=\"hidden\" name=\"${_csrf.parameterName}\" value=\"${_csrf.token}\"/> \n");
